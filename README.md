...
If a saved `/resume` pointer refers to a conversation that Claude can no longer find, Companion discards that stale pointer for the current launch and automatically starts a fresh Claude session instead of leaving the console disconnected.
